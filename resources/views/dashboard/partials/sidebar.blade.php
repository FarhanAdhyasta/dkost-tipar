        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3 ">
                @if (Request::is('dashboard'))
                    ...
                    <a class="inline-flex items-center w-full text-gray-800 text-sm font-semibold transition-colors duration-150 hover:text-gray-800 "
                        href="/dashboard">
